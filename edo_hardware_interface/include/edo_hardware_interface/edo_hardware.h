#ifndef ROS_CONTROL__EDO_HARDWARE_H
#define ROS_CONTROL__EDO_HARDWARE_H
...
{
    /// \brief Hardware interface for a edo
    class edoHardware : public hardware_interface::RobotHW 
    {
        protected:
            // Interfaces
